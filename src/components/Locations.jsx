        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px' }}>
          ...
          <div style={{ backgroundColor: '#ffffff', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 4px 15px rgba(0,0,0,0.05)' }}>
            ...
            <div style={{ padding: '30px' }}>
              ...
              <p style={{ fontSize: '16px', lineHeight: '1.6', color: '#4a4a4a', marginBottom: '20px' }}>
                Telefon: <strong style={{ whiteSpace: 'nowrap' }}><a href="tel:004984199351750" style={{ color: '#0056b3', textDecoration: 'none' }}>0841 993517-50</a></strong><br />
                E-Mail: <strong style={{ whiteSpace: 'nowrap' }}><a href="mailto:info@irepairstore24.de" style={{ color: '#0056b3', textDecoration: 'none' }}>info@irepairstore24.de</a></strong>
              </p>
          ...
          <div style={{ backgroundColor: '#ffffff', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 4px 15px rgba(0,0,0,0.05)' }}>
            ...
            <div style={{ padding: '30px' }}>
              ...
              <p style={{ fontSize: '16px', lineHeight: '1.6', color: '#4a4a4a', marginBottom: '20px' }}>
                Telefon: <strong style={{ whiteSpace: 'nowrap' }}><a href="tel:004984190042129" style={{ color: '#0056b3', textDecoration: 'none' }}>0841 900421-29</a></strong><br />
                E-Mail: <strong style={{ whiteSpace: 'nowrap' }}><a href="mailto:westpark@irepairstore24.de" style={{ color: '#0056b3', textDecoration: 'none' }}>westpark@irepairstore24.de</a></strong>
              </p>
              <div style={{ width: '100%', height: '300px', borderRadius: '8px', overflow: 'hidden' }}>
